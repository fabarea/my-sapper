                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row d-flex justify-content-center align-items-center">
                            ...
                            <a role="button" href="/" class="btn btn-info">Get it now
                                <i class="fa fa-diamond ml-1"></i>
                            </a>
                            <a role="button" href="/" class="btn btn-outline-info waves-effect"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row d-flex justify-content-center align-items-center">
                            ...
                            <a role="button" href="/" class="btn btn-success">Get it now
                                <i class="fa fa-diamond ml-1"></i>
                            </a>
                            <a role="button" href="/" class="btn btn-outline-success waves-effect"
        ...
        <div class="modal fade right" id="sideModalBRDangerDemo" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-side modal-bottom-right modal-notify modal-danger"
                ...
                <div class="modal-content">
                    ...
                    <!--Footer-->
                    <div class="modal-footer justify-content-center">
                        <a role="button" href="/" class="btn btn-danger">Get it now
                            <i class="fa fa-diamond ml-1"></i>
                        </a>
                        <a role="button" href="/" class="btn btn-outline-danger waves-effect"
                           data-dismiss="modal">No,
                            thanks</a>
                    </div>
                </div>
        ...
        <div class="modal fade left" id="sideModalBLWarningDemo" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-side modal-bottom-left modal-notify modal-warning"
                ...
                <div class="modal-content">
                    ...
                    <!--Footer-->
                    <div class="modal-footer justify-content-center">
                        <a role="button" href="/" class="btn btn-warning">Get it now
                            <i class="fa fa-diamond ml-1"></i>
                        </a>
                        <a role="button" href="/" class="btn btn-outline-warning waves-effect"
                           data-dismiss="modal">No,
                            thanks</a>
                    </div>
                </div>
