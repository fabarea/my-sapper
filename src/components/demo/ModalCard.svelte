...
<div class="card">
  ...
  <section>
    ...
    <div
      ...
      id="frameModalBottomSuccessDemo"
      tabindex="-1"
      role="dialog"
      aria-labelledby="myModalLabel"
      aria-hidden="true"
    ...
    <div
      ...
      data-backdrop="false">
      <div
        class="modal-dialog modal-side modal-top-right modal-notify
        modal-success"
        role="document">
        <!--Content-->
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="text-center">
              <i class="fa fa-check fa-4x mb-3 animated rotateIn" />
              <p>
                Lorem ipsum dolor sit amet, consectetur adipisicing elit.
    ...
    <div
      ...
      data-backdrop="false">
      <div
        class="modal-dialog modal-side modal-bottom-right modal-notify
        modal-danger"
        role="document">
        <!--Content-->
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="row">
              <div class="col-3">
                <p />
                <p class="text-center">
                  <i class="fa fa-shopping-cart fa-4x" />
                </p>
              </div>
              ...
              <div class="col-9">
                <p>
                  Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                  Fuga, molestiae provident temporibus sunt earum.
                </p>
                <h2>
    ...
    <div
      ...
      data-backdrop="false">
      <div
        class="modal-dialog modal-side modal-bottom-left modal-notify
        modal-warning"
        role="document">
        <!--Content-->
        <div class="modal-content">
            ...
            <div class="row">
              <div class="col-3 text-center">
                <img
                  ...
                  alt="Michal Szymanski - founder of Material Design for
                  Bootstrap"
    ...
    <div
      ...
      aria-hidden="true">
      <div
        class="modal-dialog modal-fluid modal-notify modal-success"
        role="document">
        <!--Content-->
        <div class="modal-content">
          <!--Header-->
    ...
    <div
      ...
      data-backdrop="false">
      <div
        class="modal-dialog modal-full-height modal-right modal-notify
        modal-success"
        role="document">
        <!--Content-->
        <div class="modal-content">
    ...
    <div
      ...
      data-backdrop="false">
      <div
        class="modal-dialog modal-full-height modal-top modal-notify
        modal-warning"
        role="document">
        <!--Content-->
        <div class="modal-content">
    ...
    <div
      ...
      data-backdrop="false">
      <div
        class="modal-dialog modal-full-height modal-bottom modal-notify
        modal-danger"
        role="document">
        <!--Content-->
        <div class="modal-content">
      ...
      <div class="col-md-3">
        ...
        <div class="text-center">
          ...
          <a
            class="btn btn-primary btn-sm"
            data-toggle="modal"
            href="#sideModalTLInfoDemo"
            data-target="#sideModalTLInfoDemo">
            Top Left
          </a>
          <br />
          <a
          ...
          <a
            class="btn btn-primary btn-sm"
            data-toggle="modal"
            href="#sideModalBLWarningDemo"
            data-target="#sideModalBLWarningDemo">
            Bottom Left
          </a>
        </div>
      </div>
      ...
      <div class="col-md-3">
        ...
        <div class="text-center">
          ...
          <button
            ...
            class="btn btn-primary btn-sm"
            data-toggle="modal"
            data-target="#centralModalFluidSuccessDemo">
            Fluid
          </button>
        </div>
      </div>
      ...
      <div class="col-md-3">
        ...
        <div class="text-center">
          ...
          <button
            ...
            class="btn btn-primary btn-sm"
            data-toggle="modal"
            data-target="#fluidModalLeftInfoDemo">
            Left
          </button>
          <br />
          <button
            ...
            class="btn btn-primary btn-sm"
            data-toggle="modal"
            data-target="#fluidModalTopWarningDemo">
            Top
          </button>
          <br />
          <button
            ...
            class="btn btn-primary btn-sm"
            data-toggle="modal"
            data-target="#fluidModalBottomDangerDemo">
            Bottom
          </button>
        </div>
      </div>
